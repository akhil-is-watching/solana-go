...
[![GoDoc](https://pkg.go.dev/badge/github.com/akhil-is-watching/solana-go?status.svg)](https://pkg.go.dev/github.com/akhil-is-watching/solana-go@v1.12.0?tab=doc)
[![GitHub tag (latest SemVer pre-release)](https://img.shields.io/github/v/tag/akhil-is-watching/solana-go?include_prereleases&label=release-tag)](https://github.com/akhil-is-watching/solana-go/releases)
[![Build Status](https://github.com/akhil-is-watching/solana-go/workflows/tests/badge.svg?branch=main)](https://github.com/akhil-is-watching/solana-go/actions?query=branch%3Amain)
[![TODOs](https://badgen.net/https/api.tickgit.com/badgen/github.com/akhil-is-watching/solana-go/main)](https://www.tickgit.com/browse?repo=github.com/akhil-is-watching/solana-go&branch=main)
[![Go Report Card](https://goreportcard.com/badge/github.com/akhil-is-watching/solana-go)](https://goreportcard.com/report/github.com/akhil-is-watching/solana-go)
...
**If you're looking for a SERUM library, you can check out [gagliardetto/serum-go](https://github.com/gagliardetto/serum-go) ([./programs/serum](https://github.com/akhil-is-watching/solana-go/tree/main/programs/serum) is deprecated.**)
...
```bash
$ cd my-project
$ go get github.com/akhil-is-watching/solana-go@v1.12.0
```
...
You can wait for a transaction confirmation using the `github.com/akhil-is-watching/solana-go/rpc/sendAndConfirmTransaction` package tools (for a complete example: [see here](#transfer-sol-from-one-wallet-to-another-wallet))
...
import (
	...
	lookup "github.com/akhil-is-watching/solana-go/programs/address-lookup-table"
	"github.com/akhil-is-watching/solana-go/rpc"
...
import (
  ...
  "github.com/akhil-is-watching/solana-go"
  "github.com/akhil-is-watching/solana-go/programs/system"
  "github.com/akhil-is-watching/solana-go/rpc"
...
import (
  ...
  "github.com/akhil-is-watching/solana-go/rpc"
  "github.com/akhil-is-watching/solana-go/rpc/jsonrpc"
)
...
import (
  ...
  "github.com/akhil-is-watching/solana-go/programs/system"
  "github.com/akhil-is-watching/solana-go/rpc"
  confirm "github.com/akhil-is-watching/solana-go/rpc/sendAndConfirmTransaction"
  "github.com/akhil-is-watching/solana-go/rpc/jsonrpc"
  "github.com/akhil-is-watching/solana-go/rpc/ws"
  "github.com/akhil-is-watching/solana-go/text"
)
...
import (
  ...
  "github.com/akhil-is-watching/solana-go/programs/token"
  "github.com/akhil-is-watching/solana-go/rpc"
)
